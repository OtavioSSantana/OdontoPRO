...
import { createNewAppoinintment } from "../_actions/create-appointments";
import {toast} from "sonner"
import { UserWithServiceAndSubscription } from "@/types/prisma"
...
export function ScheduleContent({clinic} : ScheduleContentProps){
    ...
    async function handleRegisterAppointment(formData: AppointmentFormData){
        ...
        const response = await createNewAppoinintment({
            name: formData.name,
