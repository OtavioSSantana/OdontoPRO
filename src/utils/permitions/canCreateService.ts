...
import { Subscription, Plan } from "@/types/prisma"
...
export async function canCreateService( subscription: Subscription | null,
    session: Session): Promise<ResultPermissionProp>{
